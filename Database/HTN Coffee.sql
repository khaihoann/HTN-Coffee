...
--INSERT DATA--
--------------------------------------BẢNG ROLES--------------------------------
insert into Roles(RoleName,MoTa) 
values	( N'Quản lý', N'Có chức năng quản lý website'),
		( N'Khách hàng', N'Có chức năng mua các sản phẩm'),
		( N'Nhân viên', N'Kiểm soát đơn hàng');
  
-----------------------------------BẢNG TÀI KHOẢN----------------------------
insert into TAIKHOAN(SoDienThoai,MatKhau,RoleID) 
values	('0343988241','FivemenCoffee',1),
		('0343988242','FivemenCoffee',1),
		('0962534995','FivemenCoffee',2),
		('0786667333','FivemenCoffee',2),
		('0567779900','FivemenCoffee',2),
		('0366789012','FivemenCoffee',2),
		('0995551673','FivemenCoffee',3),
		('0705620098','FivemenCoffee',3),
		('0350099001','FivemenCoffee',3),
		('0580218844','FivemenCoffee',3);
 
-----------------------------------BẢNG NHÂN VIÊN------------------------------

insert into NHANVIEN(TenNV, SoDienThoai, NgaySinh, GioiTinh, DiaChi, NgayVaoLam, ChucVu) 
values	(N'Phạm Như Long','0990009990','2001-03-03','Nam','Long An','2020-11-20','Nhan vien ban hang'),
		(N'Hoàng Ngọc Thảo Quyên','0345678990','2001-09-11','Nu','Đong Nai','2020-11-20','Nhan vien ban hang'),
		(N'Bùi Bích Chăm','0990221112','2001-01-07','Nu','Kien Giang','2020-11-20','Nhan vien ban hang'),
		(N'Lý Trần Thanh Thảo','0770033111','2001-09-09','Nu','Binh Thuan','2020-11-20','Nhan vien ban hang'),
		(N'Nguyễn Ngọc Châu Pha','0522141338','2001-04-13','Nu','Quang Ngai','2021-01-25','Nhan vien ban hang'),
		(N'Lê Văn An','0776254420','2000-12-05','Nam','TPHCM','2021-01-25','Nhan vien ban hang'),
		(N'Nguyễn Minh Hiếu','0884211492','2000-05-07','Nam','TPHCM','2021-05-09','Nhan vien ban hang'),
		(N'Phạm Thị Thanh Lan','0363559470','1998-10-03','Nu','TPHCM','2021-05-09','Nhan vien ban hang'),
		(N'Bùi Quốc Bảo','0961527810','1999-06-24','Nam','Dong Nai','2021-10-20','Nhan vien ban hang'),
		(N'Trần Lê Phương','0752326665','1995-08-25','Nam',N'Long An','2021-10-20','Nhan vien ban hang');
  
-----------------------------------BẢNG VOUCHER----------------------------------
insert into VOUCHER(TenVoucher, TiLeGiamGia, NgayBatDau, NgayKetThuc) 
values	(N'Giáng Sinh Giảm Đậm Sâu',0.3,'2021-12-01','2021-12-26'),
		(N'Giảm giá 20% mừng ngày Nhà Giáo Việt Nam',0.2,'2021-11-10','2021-11-20'),
		(N'Giảm giá 10% cuối tuần ấm áp',0.1,'2021-10-01','2021-10-02'),
		(N'Trang trí nhà xinh giảm 10%',0.1,'2021-09-12','2021-09-15'),
		(N'Voucher giảm đồng loạt 15% toàn sàn',0.15,'2021-05-05','2021-05-08'),
		(N'Voucher giảm giá 5%',0.05,'2021-04-01','2021-04-30'),
		(N'Voucher giảm giá nhân ngày Quốc Khánh',0.3,'2021-09-02','2021-09-03'),
		(N'Voucher giảm giá 10% cho bếp xinh',0.1,'2021-02-01','2021-02-08'),
		(N'Voucher giảm giá 25%',0.25,'2021-01-01','2021-01-14'),
		(N'Voucher giảm giá 20%',0.2,'2021-03-12','2021-03-19'),
		(N'Không giảm giá',0,'2020-03-12','2023-03-19');
 
-----------------------------------BẢNG DANH MỤC SẢN PHẨM-----------------
insert into DANHMUCSP(TenDanhMuc,MoTa) 
values	(N'Đồ trang trí nhà cửa',N'Đồ dùng để trang trí nhà cửa'),
		(N'Phụ kiện trang trí',N'Phụ kiện trang trí đa dạng'),
		(N'Khung ảnh và tranh treo tường',N'Khung ảnh và tranh treo tường'),
		(N'Đèn',N'Đèn trang trí các loại'),
		(N'Lọ hoa và hoa trang trí',N'Hoa và lọ hoa trang trí'),
		(N'Ngoài trời và sân vườn',N'Đồ dùng trang trí sân vườn và ngoài trời'),
		(N'Nhà bếp và phòng ăn',N'Đồ dùng nhà bếp và phòng ăn'),
		(N'Giấy và decal dán tường',N'Giấy trang trí các loại/Sticker trang trí/Decal dán tường'),
		(N'Sắc đẹp',N'Các phụ kiện làm đẹp'),
		(N'Đồ chơi',N'Các đồ chơi cho trẻ em và các đồ chơi để trang trí'),
